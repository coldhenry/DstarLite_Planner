# -*- coding: utf-8 -*-
"""
Created on Sun May 31 10:03:30 2020
...
def update(t):
    ...
    return artists 
#init_func=init,
ani = FuncAnimation(fig, update, frames=np.arange(0,0.5,delta_t),  interval=10, blit=True, repeat=False)
ani.save('ball.gif', fps=15, extra_args=['-vcodec', 'libx264'])
plt.show()
